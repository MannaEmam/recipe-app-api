...
class PublicUserApiTests(TestCase):
    ...
    def test_user_with_email_exists_error(self):
        """Test error returne if user with email exists."""
        payload = {
            'email': 'test@example.com',
            'password': 'testpass123',
            'name': 'Test Name',
    ...
    def test_password_too_short_error(self):
        """Test an error is returned if password id less than 5 chars."""
        payload = {
            'email': 'test@example.com',
            'password': 'te',
            'name': 'Test Name',
    ...
    def test_create_token_for_user(self):
        """Test generates token for valid credetnials."""
        user_details = {
            'email': 'test@example.com',
...
class PrivateUserApiTests(TestCase):
    ...
    def test_post_me_not_allopwed(self):
